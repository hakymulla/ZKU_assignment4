...
////// This circuit valid each transaction and updates the root of the Account tree
...
////// The input of the circuit are the Merkle root of the transaction tree 
////// the Merkle root of the Account tree and a list of transactions
...
////// the txExistence component is updated with appropriate transaction information like the sender and receiver addresses and State
//////  checks the the transaction exists in txRoot
    for (var i = 0; i < 2**m; i++) {
...
//////  checks the the transaction is signed by the owner
